...
class TP_facebook {
	...
	public function get_post_feed($user,$app_id,$app_secret,$item_count=10){
		...
		$url = "https://graph.facebook.com/$user/feed?".$oauth."&fields=id,from,message,pictures,link,name,icon,privacy,type,status_type,object_id,application,created_time,updated_time,is_hidden,is_expired,likes,comments";
