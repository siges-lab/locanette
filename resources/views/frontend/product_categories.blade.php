@section('title')Produits | Categories @endsection
@section('styles')
    <style>
        .datepicker {
                                ...
                                @foreach($products as $product)
                                    <div class="col-lg-4 col-sm-6">
                                        ...
                                        <div class="l_product_item">
                                            <a href="{{url('get-product/'.$product->id)}}">
                                                <div class="l_p_img">
                                                    <img src="{{asset('public/pictures/products/'.$product->product_pictures->first()->link)}}" alt="">
                                                    <h5 class="new">New</h5>
                                                </div>
                                            </a>
                                            ...
                                            <div class="l_p_text">
                                                ...
                                                <h5><del>{{$product->rental_price}}</del>  {{$product->rental_price}}</h5>
                                            </div>
