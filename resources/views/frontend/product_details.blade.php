            ...
            <div class="row">
                        ...
                        <div id="product_slider2" class="rev_slider" data-version="5.3.1.6">
                            <ul>
                                ...
                                @foreach($product->product_pictures as $picture)
                                    ...
                                    <li data-index="rs-{{$picture->id}}" data-transition="scaledownfromleft" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="1500"  data-thumb="{{asset('public/pictures/products/'.$picture['link'])}}"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Umbrella" data-param1="September 7, 2015" data-param2="Alfon Much, The Precious Stones" data-description="">
                                        <!-- MAIN IMAGE -->
                                        <img src="{{asset('public/pictures/products/'.$picture['link'])}}"  alt=""  width="1920" height="1080" data-lazyload="{{asset('public/pictures/products/'.$picture['link'])}}" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                        <!-- LAYERS -->
                                    </li>
                                @endforeach
                            </ul>
                ...
                <div class="col-lg-7">
                    <div class="product_details_text">
                        ...
                        <h6> @if($product->amount_stored) Disponible en <span>Stock</span> @else <span style="color: red;"> En rupture</span> @endif  </h6>
                        <h4>{{$product->rental_price}}  FCFA</h4>
                    ...
                    @foreach($relateds as $related)
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                    <img class="img-fluid" src="{{asset('public/pictures/products/'.$related->first()->product_pictures->first()->link)}}" alt="">
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                    ...
                                    <h4>{{$related->designation}}</h4>
                                    <h5>{{$related->rental_price}}</h5>
                                </div>
                            </div>
                        </div>
                    @endforeach
